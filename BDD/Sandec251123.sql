...
INSERT INTO `categorias` VALUES (1,'Telefonos','Hola que hace','Activo'),(2,'Telefonia','Son de telefonos','Activo'),(3,'Micas','Mica Cristal Templado','Activo');
...
INSERT INTO `clientes` VALUES (1,'Publico','Publico','4491234569','public@sandec.com','Activo'),(2,'Max','Centro','111111','1111','Activo'),(3,'Ernesto','Holiii','22222','222222','Activo');
...
INSERT INTO `detalles_venta` VALUES (2,2,1,1,15.00,'Activo'),(3,5,1,2,15.00,'Activo'),(4,5,2,1,20.00,'Activo'),(5,2,4,12,12.00,'Activo'),(6,2,4,12,12.00,'Activo');
...
INSERT INTO `productos` VALUES (1,'Prueba de Put','Holaaaaa',80.00,100.00,45,5,2,NULL,'2023-11-24 05:33:57','Activo'),(2,'minion','tarolero',80.00,100.50,50,10,1,NULL,'2023-08-06 06:00:00','activo'),(3,'Iphone 13','Es el nuevo iphone',1000.00,123.00,12,1,1,NULL,'2023-11-25 17:05:00','Activo'),(4,'Mica Iphone 11','Mica Iphone 11',15.00,180.00,48,2,1,'','2023-11-24 05:09:22','Activo'),(5,'Iphone 12 Pro Max','El mejor iphone de la historia',15000.00,20000.00,15,5,2,_binary 'imagenIphone','2023-10-16 16:25:08','Activo');
...
INSERT INTO `proveedores` VALUES (1,'Rafael','Lejos lejos','3333','33333','Activo'),(2,'Salvador Heredia','13 de junio','4456938574','ricasnelas@fmail.com','Activo'),(3,'Juan Perez','PLaza de la Tecnologia #152','4495632154','Juan@gmail.com','Activo');
...
INSERT INTO `vendedor` VALUES (2,'Rafael','Rajospagus','4493018317','Activo'),(3,'Ricardo Salvador','Sandec','4491635287','Activo'),(4,'Juanes','Duele','22222','Activo');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `putCategoria` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `putCategoria`(
    `_idCategoria` int(11),
	`_nombre` varchar(255),
    `_descripcion` varchar(255), 
    `_status` varchar(45)
...
BEGIN
    ...
    set @strSentenciaUpdate = 'update `categorias` SET ';
		if (`_nombre` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`nombre` = "',`_nombre`,'"');
        ...
        if (`_descripcion` is not null) then
            ...
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`descripcion` = "',`_descripcion`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_status` is not null) then
            ...
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`status` = "',`_status`,'"');
            set blnActualizacionValida = true;
        end if;
		if (blnActualizacionValida) then
			set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,' where `id` = "',`_idCategoria` ,'"');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `putCliente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `putCliente`(
    `_idCliente` int(11),
	`_nombre` varchar(255), 
    `_direccion` varchar(255), 
...
BEGIN
    DECLARE blnActualizacionValida boolean DEFAULT false;
    DECLARE intEstatus int DEFAULT 200;
    set @strSentenciaUpdate = 'update `clientes` SET ';
		if (`_nombre` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
        ...
        if (`_direccion` is not null) then
            ...
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`direccion` = "',`_direccion`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_telefono` is not null) then
            ...
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`telefono` = "',`_telefono`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_email` is not null) then
            ...
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`email` = "',`_email`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_status` is not null) then
			if(blnActualizacionValida) then
		...
		if (blnActualizacionValida) then
			set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,' where `id` = "',`_idCliente` ,'"');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `putProductos` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `putProductos`(
    `_idProducto` int(11),
	`_nombre` varchar(255),
    `_descripcion` varchar(255), 
    `_precio_compra` DECIMAL(10,2), 
...
BEGIN
    DECLARE blnActualizacionValida boolean DEFAULT false;
    DECLARE intEstatus int DEFAULT 200;
    set @strSentenciaUpdate = 'update `productos` SET ';
		if (`_nombre` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
        ...
        if (`_precio_compra` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`precio_compra` = "',`_precio_compra`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_precio_venta` is not null) then
            ...
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`precio_venta` = "',`_precio_venta`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_cantidad_stock` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`cantidad_stock` = "',`_cantidad_stock`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_cantidad_minima` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`cantidad_minima` = "',`_cantidad_minima`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_categoriaId` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`categoriaId` = "',`_categoriaId`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_status` is not null) then
			if(blnActualizacionValida) then
		...
		if (blnActualizacionValida) then
			set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,' where `id` = "',`_idProducto` ,'"');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `putProveedor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `putProveedor`(
    `_idProveedor` int(11),
	  `_nombre` varchar(255), 
    `_direccion` varchar(255), 
    `_telefono` varchar(255), 
...
BEGIN
    DECLARE blnActualizacionValida boolean DEFAULT false;
    DECLARE intEstatus int DEFAULT 200;
    set @strSentenciaUpdate = 'update `proveedores` SET ';
		if (`_nombre` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
		...
		if (blnActualizacionValida) then
			set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,' where `id` = "',`_idProveedor` ,'"');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `putVendedor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `putVendedor`(
    `_idVendedor` int(11),
    `_nombreVendedor` varchar(45), 
    `_nombreNegocio` varchar(45), 
    `_telefonoContacto` varchar(45), 
...
BEGIN
    DECLARE blnActualizacionValida boolean DEFAULT false;
    DECLARE intEstatus int DEFAULT 200;
    set @strSentenciaUpdate = 'update `vendedor` SET ';
		if (`_nombreVendedor` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`nombreVendedor` = "',`_nombreVendedor`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_nombreNegocio` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`nombreNegocio` = "',`_nombreNegocio`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_telefonoContacto` is not null) then
			if(blnActualizacionValida) then
				set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,',');
            end if;
            set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,'`telefonoContacto` = "',`_telefonoContacto`,'"');
            set blnActualizacionValida = true;
        end if;
        if (`_status` is not null) then
			if(blnActualizacionValida) then
		...
		if (blnActualizacionValida) then
			set @strSentenciaUpdate = CONCAT(@strSentenciaUpdate,' where `id` = "',`_idVendedor` ,'"');
...
-- Dump completed on 2023-11-25 11:08:26
